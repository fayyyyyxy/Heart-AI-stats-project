...
# Read the CSV file
df = pd.read_csv('/Users/student/Desktop/event_or_death.csv')
...
categorical_cols = [X.columns[i] for i in [2,3,4,5,6,7,8,9,23]]
...
plt.title('Receiver Operating Characteristic (ROC)(MACE)')
...
plt.ylabel('Features')
plt.title('Variable Ranking for Prediction of MACE')
